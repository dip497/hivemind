...
// Install the RESULT: `hive views install examples/views/tiled/dist`.
...
await build({
  ...
  outfile: path.join(dist, "tiled.js"), logLevel: "warning",
});
for (const f of ["index.html", "tiled.css"]) cpSync(path.join(here, "src", f), path.join(dist, f));
