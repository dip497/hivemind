...
// Snapshots hold whatever was on screen, so they are owner-only regardless of umask.
try { fs.mkdirSync(sessionsDir, { recursive: true, mode: 0o700 }); fs.chmodSync(sessionsDir, 0o700); } catch { /* ignore */ }
