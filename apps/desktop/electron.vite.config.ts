...
const BUNDLE_INTERNAL = ["@hivemind/core", "@hivemind/core/storage", "@hivemind/agents", "@hivemind/agents/node", "@hivemind/view-sdk", "@hivemind/view-sdk/manifest", "@hivemind/view-sdk/protocol"];
