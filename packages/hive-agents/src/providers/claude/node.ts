 ...
 *
 * Electron-free and unit-testable (the daemon itself imports node-pty, which
 * needs the Electron ABI). The daemon wires these into SessionManager via the
 * catalog's node parts; tests drive them with a fake claude.
 *
 * The model:
