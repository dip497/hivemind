/**
 * Copilot — recognised for status scraping when a user runs
...
export const copilot: AgentProviderDef = {
  ...
  install: { url: "https://docs.github.com/en/copilot/how-tos/set-up/install-copilot-cli", command: "npm install -g @github/copilot" },
  /** GitHub Copilot mark (simple-icons). */
  icon: {
    viewBox: "0 0 24 24",
